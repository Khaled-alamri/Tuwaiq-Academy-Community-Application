...
List<GetPage<dynamic>>? getPages = [
  ...
  GetPage(
    name: RouterNames.GuestAppLayout,
    page: () => GuestAppLayout(),
  ),
  GetPage(
    name: RouterNames.FutureCamp,
    page: () => FutureCamp(),
  ),
  GetPage(
    name: RouterNames.PresentCamp,
    page: () => PresentCamp(),
  ),
  GetPage(
    name: RouterNames.ArticleView,
    page: () => ArticleView(),
  ),
  GetPage(
    name: RouterNames.GustArticleView,
    page: () => GustArticleView(),
  ),
  GetPage(
    name: RouterNames.GusteProblemScreen,
    page: () => GusteProblemScreen(),
  ),
  GetPage(
    name: RouterNames.TermsAndCondition,
